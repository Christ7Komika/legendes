...
export default function CartInfo({ album, editQuantity }: CartInfoProps) {
      ...
      <div className="px-3 pt-3">
        ...
        <div className="flex items-center space-x-2 mt-1">
          ...
          <input
            ...
            className="bg-neutral-100 p-2 rounded-md focus-visible:outline-1 focus-visible:outline-neutral-400 w-20 h-7 text-neutral-600 text-sm"
          />
        </div>
      </div>
    </div>
